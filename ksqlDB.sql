...
CREATE STREAM TRANSACTION_FORMATED
WITH (KAFKA_TOPIC='TRANSACTION_FORMATED', PARTITIONS=6, REPLICAS=3) as 
select 
...
CREATE STREAM TRANSACTION_FULL
...
from TRANSACTION_FORMATED T
left join USERS U
on T.USER_ID=U.USERID['USERID']
left join CARDS C
on T.CARD_ID = C.CARD_ID['CARD_ID']
left join STORES S
on T.STORE_ID = S.STORE_ID['STORE_ID']
EMIT CHANGES;
